...
$(document).on('click', '.edit-ticket-link', function () {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $('#ticket-sel').val(ticket.assigned_devs.map(function(dev) { return dev.id; }));
        ...
        .then(data => {
          ...
          <div class="row pt-3 pb-2">
            <div class="col-sm-3">
              ...
              <div><span class="badge rounded-pill badge-c">${data.status}</span></div>
            </div>
            <div class="col-sm-3">
              <div class="ps-5 pb-2 ms-1 text-color6">Priority</div>
              <div class="ps-5"><span class="badge rounded-pill badge-c">${data.priority}</span></div>
            </div>
            <div class="col-sm-3">
              <div class="ps-5 pb-2 ms-1 text-color6">Type</div>
              <div class="ps-5"><span class="badge rounded-pill badge-c">${data.ticket_type}</span></div>
            </div>
            <div class="col-sm-3">
          ...
          const commentsContainer = commentsDiv.querySelector('.comments-container');
          ...
          const deleteCommentLinks = document.getElementsByClassName('delete-comment-link');
